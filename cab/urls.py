...
from cab.views import RouteList, CompanyList, DriverList, BookingList, BookingDetails, NearbyDrivers, CarList, CarBookingCRUD
urlpatterns = [
    ...
    path("cars/booking", CarBookingCRUD.as_view(), name="cars")
]
